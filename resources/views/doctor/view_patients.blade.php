                        ...
                        <div class="card white-box p-0">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row p-3 mt-0">
                                    <div class="p-2"><img src="doctor/plugins/images/users/varun.jpg" alt="user" style="max-width:100%;height:auto;"width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="doctor/plugins/images/users/genu.jpg" alt="user" style="max-width:100%;height:auto;" class="rounded-circle"></div>
