    ...
    <div class="container">
      ...
      <form class="main-form">
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="doctors" id="doctors" class="custom-select">
              <option value="general">doctor 1</option>
              <option value="cardiology">doctor 2</option>
              <option value="dental">doctor 3</option>
              <option value="neurology">doctor 4</option>
            </select>
        </div>
      </div>
