            ...
            @include('admin.navbar') 
              ...
              <table style=" width:1000px;">
                      <tr style="background-color:rgb(138, 235, 135);">
                          ...
                          <th style="padding:10px; color:black;">Age</th>
                      ...
                      <tr align="center" style="background-color:rgb(23, 73, 29);">
                          ...
                          <td>
                              <a class="btn btn-danger" href="{{url('deletepatient',$patient->id)}}" onclick="return confirm('Are you sure you want to cancel this patient')">Delete</a>
                          </td>
                      </tr>
                      @endforeach
                </table>
